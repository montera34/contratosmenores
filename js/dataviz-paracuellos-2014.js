...
d3.tsv("data/viplist_paracuellos2014.tsv", function(error, data) {//reads the viplist.tsv file
...
//Legend de cosas
d3.tsv("data/thinglist_paracuellos2014.tsv", function(error, data) {//reads the thinglist.tsv file
...
d3.tsv("data/centroslist_paracuellos2014.tsv", function(error, data) {//reads the thinglist.tsv file
...
d3.tsv("data/data_paracuellos2014.tsv", type, function(error, data) {//reads the data.tsv file
